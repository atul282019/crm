...
//import com.cotodel.crm.web.response.DirectorOnboarding;
//import com.cotodel.crm.web.response.EmployeeDeactiveRequest;
import com.cotodel.crm.web.response.EmployeeOnboarding;
import com.cotodel.crm.web.response.UserDetailsEntity;
import com.cotodel.crm.web.service.EmployeeDetailService;
import com.cotodel.crm.web.service.Impl.TokenGenerationImpl;
import com.cotodel.crm.web.util.Base64FileUtil;
...
import com.cotodel.crm.web.response.ErupiLinkBankAccount;
...
//		if ((obj.getUser_role() == 9 || obj.getUser_role() == 1 || obj.getUser_role() == 3) && obj.getOrgid() == erupiLinkBankAccount.getOrgId().intValue()) {
			try {
				...
				String encriptResponse =  employeeDetailService.getErupiLinkDlinkAccountDetail(tokengeneration.getToken(), jsonObject);
