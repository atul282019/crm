...
//	
	...
	@GetMapping(value="/crmtabaddnew")
	public ModelAndView crmtabaddnew(Model model) {
		String token = (String) session.getAttribute("hrms");
		Integer id  = (Integer) session.getAttribute("id");
		if(token!=null) {
			UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
			if(obj!=null) {
				...
				return new ModelAndView("crmtabaddnew", "command", "");
			}
			 return new ModelAndView("error", "command", "");
		}
		return new ModelAndView("index", "command", "");
	...
	public ModelAndView crm(Model model) {
		String token = (String) session.getAttribute("hrms");
		Integer id  = (Integer) session.getAttribute("id");
		if(token!=null) {
			UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
			if(obj!=null) {
				...
				return new ModelAndView("crm", "command", "");
			}
			 return new ModelAndView("error", "command", "");
		}
		return new ModelAndView("index", "command", "");
