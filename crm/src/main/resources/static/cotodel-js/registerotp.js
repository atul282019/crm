...
function userRegistration() {
  ...
  const companySizeValue = companySize ? companySize.value : null;
 // const privacyCheck = document.getElementById("terms").checked;
  ...
  if (!name) {
    ...
    document.getElementById("usernameError1").innerHTML = "Special characters not allowed in name";
    document.getElementById("username").focus();
    return false;
  } else {
    document.getElementById("usernameError1").innerHTML = "";
  ...
  if (!orgname) {
    document.getElementById("orgnameError1").innerHTML = "Please Enter Company Name";
    document.getElementById("orgname").focus();
    return false;
  } else {
    document.getElementById("orgnameError1").innerHTML = "";
  ...
  if (!companyType) {
    document.getElementById("companyTypeError").innerHTML = "Please Select Company Type";
    document.getElementById("companyType").focus();
    return false;
  } else {
    document.getElementById("companyTypeError").innerHTML = "";
  }
